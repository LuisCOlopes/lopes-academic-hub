...
export const pagesTranslations = {
  ...
  // About page
  aboutTitle: 'Sobre',
  aboutSubtitle: 'Conheça minha trajetória acadêmica e profissional',
  ...
  // News page
  newsTitle: 'Notícias',
  newsSubtitle: 'Últimas atualizações e desenvolvimentos em engenharia química',
  readMore: 'Leia Mais',
  
  // Blog page
  blogTitle: 'Blog',
  blogSubtitle: 'Reflexões e pensamentos sobre engenharia química e educação',
  
  // Meeting page
  meetingTitle: 'Solicitar Reunião',
  meetingSubtitle: 'Solicite uma reunião para discutir pesquisa, colaboração ou questões acadêmicas',
  firstName: 'Nome',
  lastName: 'Sobrenome',
  email: 'E-mail',
  ...
  computationalCodesDescription: 'Códigos e scripts para simulação de processos',
  ...
  assignmentsDescription: 'Exercícios e atividades para download',
  access: 'Acessar',
  explore: 'Explorar',
  download: 'Download',
  ...
  speakingOpportunitiesDescription: 'Interessado em me ter como palestrante em sua conferência ou evento? Estou sempre aberto a compartilhar conhecimento e insights.',
  keynoteSpeeches: 'Palestras Principais',
  keynoteDescription: 'Insights estratégicos e visão da indústria',
  technicalSessions: 'Sessões Técnicas',
  technicalDescription: 'Apresentações de pesquisa detalhadas',
  panelDiscussions: 'Discussões em Painel',
  panelDescription: 'Discussões interativas entre especialistas',
  topic: 'Tópico',
  availableMaterials: 'Materiais Disponíveis',
