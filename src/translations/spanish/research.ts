...
export const researchTranslations = {
  ...
  faultTolerantControlProject: 'Sistemas de Control Tolerantes a Fallos',
  ...
  dynamicOperabilityDescription: 'Análisis y optimización de la operabilidad dinámica en procesos químicos para mejorar flexibilidad y rendimiento.',
  faultTolerantControlDescription: 'Diseño de sistemas de control tolerantes a fallos para garantizar operación segura y confiable de procesos químicos.',
  ...
  safetyDescription: 'Análisis de seguridad y tolerancia a fallos en sistemas químicos',
  ...
  orientationFlowcharts: 'Diagramas de Flujo de Orientación',
